...
import { getRadioCellNTPStats } from '../../../services/ntp';
import { FilterType, FilterTypes } from '../../../types/filters';
...
export const Chart = ({ cellId }: ChartProps) => {
    const [criteria, setCriteria] = useState<FilterType>(FilterTypes.UPLINK);
    ...
    const {
        ...
        [QUERY.CELL_NTP.GET_STATS, criteria],
        () => getRadioCellNTPStats(cellId, criteria),
        {
            enabled: !!cellId,
    ...
    const filters = [
        {
            value: FilterTypes.UPLINK,
        },
        {
            value: FilterTypes.DOWNLINK,
        },
    ];
    return (
